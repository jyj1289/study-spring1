package com.yujin.freelecspringboot2webservice.service.posts;

import com.yujin.freelecspringboot2webservice.domain.posts.Posts;
import com.yujin.freelecspringboot2webservice.domain.posts.PostsRepository;
...
public class PostsService {
    ...
    public void delete(Long id){
        ...
        postsRepository.delete(posts);  // JpaRepository에서 이미 delete메서드를 지원하고 있다. 엔티티를 파라미터로 삭제할 수도 있고, deleteById메서드를 이용하면 id로 삭제할 수 있다.
    }
}
